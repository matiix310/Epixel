        ...
        <div className={styles.body}>
            ...
            <div className={styles.popup}>
                ...
                <div className={styles.loginContainer}>
                    <LoginButton label={"Azure AD"} buttonClass={styles.azureLoginButton as string} onClick={() => signIn("azure-ad", {callbackUrl})}/>
                    <div className={styles.separator}>
                        <img src="/left_separator.png" alt=""/>
                        <h1>OR</h1>
                        <img src="/left_separator.png" alt="" style={{transform: "rotate(180deg)"}}/>
                    </div>
                    <form className={styles.credsForm} onSubmit={(e) => {
                        e.preventDefault();
                        ...
                        <LoginButton label="LOGIN" buttonClass={styles.credsLoginBtn} onClick={() => signInWithCreds(username, password, callbackUrl)} />
